...
class Bus_Fide_ruta : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener {
    ...
    override fun onMyLocationButtonClick(): Boolean {
        Toast.makeText(this, "Bus de Fidelitas", Toast.LENGTH_SHORT).show()
        return false
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.menu_map -> {
                startActivity(Intent(this, Bus_Fide_ruta::class.java))
                true
            }
            R.id.menu_contacto -> {
